...
-- fs, http, io, turtle
shell.run = function(...)
    lib.permit.checkUserPermission("shell.run")
...
shell.execute = function(command, ...)
    lib.permit.checkUserPermission("shell.execute")
...
shell.resolve = function(path)
    lib.permit.checkUserPermission("shell.resolve")
...
shell.path = function()
    lib.permit.checkUserPermission("shell.path")
...
os.run = function(env, path, ...)
    lib.permit.checkUserPermission("os.run")
...
os.shutdown = function()
    lib.permit.checkUserPermission("os.shutdown")
...
os.reboot = function()
    lib.permit.checkUserPermission("os.reboot")
...
os.setComputerLabel = function(label)
    lib.permit.checkUserPermission("os.setComputerLabel")
...
settings.define = function(name, options)
    lib.permit.checkUserPermission("settings.define")
...
settings.undefine = function(name)
    lib.permit.checkUserPermission("settings.undefine")
...
settings.set = function(name, value)
    lib.permit.checkUserPermission("settings.set")
...
settings.unset = function(name)
    lib.permit.checkUserPermission("settings.unset")
...
settings.clear = function()
    lib.permit.checkUserPermission("settings.clear")
...
settings.load = function(sPath)
    lib.permit.checkUserPermission("settings.load")
