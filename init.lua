...
-- fs, http, io, turtle
shell.run = function(...)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "shell.run")
...
shell.execute = function(command, ...)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "shell.execute")
...
shell.resolve = function(path)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "shell.resolve")
...
shell.path = function()
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "shell.path")
...
os.run = function(env, path, ...)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "os.run")
...
os.shutdown = function()
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "os.shutdown")
...
os.reboot = function()
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "os.reboot")
...
os.setComputerLabel = function(label)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "os.setComputerLabel")
...
settings.define = function(name, options)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.define")
...
settings.undefine = function(name)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.undefine")
...
settings.set = function(name, value)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.set")
...
settings.unset = function(name)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.unset")
...
settings.clear = function()
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.clear")
...
settings.load = function(sPath)
    lib.permit.checkUserPermission(lib.users.getCurrentUser(), "settings.load")
