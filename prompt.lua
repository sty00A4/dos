...
local gui = require("deepslate.gui")
local event = require("deepslate.event")
return setmetatable({
    ---a confirm prompt
    ---@param text string
    ---@param w number|nil
    ...
    ---@param fg number|nil
    ---@param bg number|nil
    ---@param ok gui.button|nil
    ---@param cancel gui.button|nil
    ---@return boolean
    confirm = function(text, w, h, fg, bg, ok, cancel)
        ...
        local cancelButton = cancel or gui.button {
        ...
        local okButton = ok or gui.button {
